...
<div class="box" style='max-width:80.5%;margin-left:125px'>
    <div class="box-header with-border">
        <h3 class="box-title">Data Laporan Siswa/i</h3>
        <div class="container">
            <div class="alert"></div>
    ...
    <div class="box-body">
            ...
            <div class="modal-header" style='text-align:center'>
                ...
                <span id="print-area">
                        ...
                        <tr>
                            ...
                            <td> <br>
                                <p style='text-align: center;font-size:20px;'><b>
                                        <font size='5px'>DATA LAPORAN SISWA/I</font>
                                    </b></p>
                            </td>
                        </tr>
                    </table>
                    <table style='text-align:left;font-weight:bold;margin-left:40px;'>
                        <tr>
                            <td width='200px' class='tr'>Kelas</td>
                            <td>:&nbsp;</td>
                        ...
                        <tr>
                            <td width='200px' class='tr'>Jurusan</td>
                            <td class='tr'>:&nbsp;</td>
                    ...
                    <table style='text-align: center;margin-top:-20px;' border="2" cellspacing="0" width="100%">
                        <thead>
                            <tr style='background-color:#00ccff !important'>
                                ...
                                <th width='150px' rowspan="2">Jenis Kelamin</th>
        ...
        <p style='margin-left:80%'> 
                            <td width='200px' class='tr'>Operator </td>
                            <td class='tr'>:&nbsp;</td>
                            <td class='tr'><?= $user->first_name ?></td> <br> <tr></tr> </p>
            </div>
