            ...
            <div class='box box-warning'>
                ...
                <div class='box-body'>
                    <form id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        ...
                        <label for="nama_karyawan" class="control-label">Nama Siswa/i</label>
                            <div class="input-group">
                                <input type="text" name="nama_karyawan" class="form-control" placeholder="nama siswa/i" value="<?php echo $nama_karyawan; ?>" readonly />
