...
<div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <!-- fungsi untuk input nama yang akan di generate qr nya -->
                        <div class="box-body">
                        ...
                        <!-- fungsi sebagai tombol submitnya -->
    ...
    <!-- pengarah ke halaman css untuk style id card siswanya -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/plugins/jQueryUI/css/jquery-ui.css">
    <!-- pengarah ke halaman plugin javascrip jquery-ui untuk scrip pembuatan id card qr -->
    ...
    <script type="text/javascript">
        ...
        function ready() {
            // berfungsi sebagai pengambilan data dari id atau primery key nya
            var id = $('#id').val();
            // $.ajax adalah fungsi dalam library JavaScript jQuery yang digunakan untuk melakukan permintaan HTTP asynchronous (asinkron) ke server.
            $.ajax({
                type: 'POST',
