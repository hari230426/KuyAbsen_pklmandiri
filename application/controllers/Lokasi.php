...
class Lokasi extends CI_Controller
{
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('success', 'Berhasil merubah data kelas'));
            redirect(site_url('lokasi'));
        }
    }
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('danger', 'Data Kelas tidak ditemukan'));
            redirect(site_url('lokasi'));
        }
    }
    ...
    {
        $this->form_validation->set_rules('nama_gedung', 'nama jurusan', 'trim|required');
