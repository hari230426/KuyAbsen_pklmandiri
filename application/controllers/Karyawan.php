...
class Karyawan extends CI_Controller
{
    ...
    public function rd($id)
    {
        ...
        if ($row) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('error', 'Data siswa/i tidak ditemukan!'));
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('success', 'Berhasil menambahkan siswa/i'));
            redirect(site_url('karyawan'));
        }
    }
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('success', 'Berhasil merubah data siswa/i'));
            redirect(site_url('karyawan'));
        }
    }
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('success', 'Berhasil menghapus data siswa/i'));
            redirect(site_url('karyawan'));
        } else {
    ...
    {
        $this->form_validation->set_rules('nama_karyawan', 'nama siswa/i', 'trim|required');
