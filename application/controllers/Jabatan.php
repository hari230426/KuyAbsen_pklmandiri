...
class Jabatan extends CI_Controller
{
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('success', 'Berhasil menambahkan jenis kelamin'));
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('success', 'Berhasil merubah jenis kelamin'));
            redirect(site_url('jabatan'));
        }
    }
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('success', 'Berhasil menghapus jenis kelamin'));
            redirect(site_url('jabatan'));
        } else {
            $this->session->set_flashdata('messageAlert', $this->messageAlert('danger', 'jenis kelamin tidak ditemukan'));
            redirect(site_url('jabatan'));
        }
    }
    ...
    {
        $this->form_validation->set_rules('nama_jabatan', 'nama gender', 'trim|required');
