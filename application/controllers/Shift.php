...
class Shift extends CI_Controller
{
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('success', 'Berhasil menambahkan jurusan'));
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('success', 'Berhasil merubah data jurusan'));
            redirect(site_url('shift'));
        }
    }
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            ...
            $this->session->set_flashdata('messageAlert', $this->messageAlert('success', 'Berhasil menghapus data jurusan'));
            redirect(site_url('shift'));
        } else {
            $this->session->set_flashdata('messageAlert', $this->messageAlert('danger', 'Data jurusan tidak ditemukan'));
            redirect(site_url('shift'));
        }
    }
    ...
    {
        $this->form_validation->set_rules('nama_shift', 'nama jurusan', 'trim|required');
